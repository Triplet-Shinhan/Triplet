...
export default function DiaryMain() {
  ...
  useEffect(() => {
    ...
    spaceDate = (new Date(tripEnd) - new Date(tripStart)) / (1000 * 60 * 60 * 24);
    let dayNum = 0;
    const fractals = Array.from({ length: spaceDate + 1 }, (_, index) => (
      <DiaryFractal
        ...
        isValid={isValid}
        day={dayNum + 1}
        dailyInfo={isValid && tripData !== undefined && tripData.dailies[dayNum++]}
      />
    ));
          ...
          <section className="dashboard">
            ...
            <section className="boardArea">
              <section className="spentMoney">
                ...
                <article>
                  <div className="moneyPart">{tripData.dashboard.sumExpenditure}</div>
